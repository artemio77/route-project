...
public abstract class BaseWorkerThread extends Thread implements SelfMonitoringThread {
    ...
    public BaseWorkerThread(String name, int id, int index) {
        ...
        setDefaultUncaughtExceptionHandler((t, e) -> getLogger().error("Uncaught exception by thread {}:", t.getName(), e));
        this.timers = new LinkedList<>();
        this.checkpoint = new Checkpoint();
        this.messageQueue = new ConcurrentLinkedQueue<>();    //TODO: consider a bounded queue here
    ...
    protected void triggerTimers() {
        ...
        Set<TimerEvent<?>> timersToRun = new TreeSet<TimerEvent<?>>((o1, o2) -> (int) (o1.fireAt - o2.fireAt));
